...
/**
 * @file TactileRelativeTfFactor.cpp
 * @brief relative transform in a moving reference frame(vars: obj, ee poses)
 * @author Paloma Sodhi
 */

#ifndef TACTILE_RELATIVE_TF_FACTOR
#define TACTILE_RELATIVE_TF_FACTOR
...
class TactileRelativeTfFactor : public gtsam::NoiseModelFactor4<gtsam::Pose2, gtsam::Pose2, gtsam::Pose2, gtsam::Pose2> {
 private:
 ...
 public:
     TactileRelativeTfFactor(gtsam::Key objKey1, gtsam::Key objKey2, gtsam::Key eeKey1, gtsam::Key eeKey2,
  ...
  gtsam::Vector evaluateError(const gtsam::Pose2& objPose1, const gtsam::Pose2& objPose2, const gtsam::Pose2& eePose1, const gtsam::Pose2& eePose2,
    ...
    gtsam::Vector3 errVec = TactileRelativeTfFactor::transformError(objPose1, objPose2, eePose1, eePose2, poseRelMeas);
    ...
    if (useAnalyticJacobians_) {
      ...
      J1 = gtsam::numericalDerivative11<gtsam::Vector3, gtsam::Pose2>(boost::bind(&TactileRelativeTfFactor::transformError, this, _1, objPose2, eePose1, eePose2, poseRelMeas), objPose1);
      J2 = gtsam::numericalDerivative11<gtsam::Vector3, gtsam::Pose2>(boost::bind(&TactileRelativeTfFactor::transformError, this, objPose1, _1, eePose1, eePose2, poseRelMeas), objPose2);
      J3 = gtsam::numericalDerivative11<gtsam::Vector3, gtsam::Pose2>(boost::bind(&TactileRelativeTfFactor::transformError, this, objPose1, objPose2, _1, eePose2, poseRelMeas), eePose1);
      J4 = gtsam::numericalDerivative11<gtsam::Vector3, gtsam::Pose2>(boost::bind(&TactileRelativeTfFactor::transformError, this, objPose1, objPose2, eePose1, _1, poseRelMeas), eePose2);
    }
